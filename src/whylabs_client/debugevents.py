...
class DebugEvents:
    ...
    def log_debug_event(self, org_id: str, dataset_id: str, debug_event: components.DebugEvent) -> operations.LogDebugEventResponse:
        r"""Log a debug event
        Create a debug event.
        """
        hook_ctx = HookContext(operation_id='LogDebugEvent', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        request = operations.LogDebugEventRequest(
            org_id=org_id,
        ...
        res = operations.LogDebugEventResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
