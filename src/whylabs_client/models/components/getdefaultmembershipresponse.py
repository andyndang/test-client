...
class GetDefaultMembershipResponseMembership:
...
class GetDefaultMembershipResponse:
    ...
    membership: Optional[GetDefaultMembershipResponseMembership] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('membership'), 'exclude': lambda f: f is GetDefaultMembershipResponse.UNSET }})
