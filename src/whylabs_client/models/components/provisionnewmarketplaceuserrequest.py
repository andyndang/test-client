...
class ProvisionNewMarketplaceUserRequest:
    ...
    expect_existing: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expectExisting'), 'exclude': lambda f: f is ProvisionNewMarketplaceUserRequest.UNSET }})
